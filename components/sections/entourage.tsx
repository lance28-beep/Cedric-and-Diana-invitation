...
export function Entourage() {
  ...
  const SectionTitle = ({ 
    ...
    return (
       <h3
         className={`relative ${greatVibes.className} text-base sm:text-lg md:text-xl lg:text-2xl font-normal text-[#85441E] mb-1 sm:mb-1.5 md:mb-2 ${textAlign} ${className} transition-all duration-300 whitespace-nowrap`}
       >
        {children}
      </h3>
    )
  ...
  const NameItem = ({
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#85441E]/20 to-transparent opacity-0 group-hover/item:opacity-100 transition-opacity duration-300 rounded-md" />

        <p
          className={`relative text-[#85441E] text-[11px] sm:text-[13px] md:text-sm lg:text-base font-semibold ${textAlign} group-hover/item:text-[#85441E] transition-all duration-300`}
        >
          {member.Name}
        </p>
        {showRole && member.RoleTitle && (
          <p
            className={`relative text-[#85441E]/70 text-[9px] sm:text-[10px] md:text-[10px] lg:text-xs font-medium mt-0 leading-tight ${textAlign} tracking-wide uppercase group-hover/item:text-[#85441E] transition-colors duration-300`}
          >
            {member.RoleTitle}
          </p>
        )}
  ...
  return (
    <section
      ref={sectionRef}
      id="entourage"
      className="relative py-8 md:py-10 lg:py-12 overflow-hidden bg-[#EFBE94]"
    >
      ...
      <div className={`relative z-30 text-center mb-4 sm:mb-5 md:mb-6 px-3 sm:px-4 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
        ...
        <h2
          className={`${cinzel.className} text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#85441E] mb-1 sm:mb-2 md:mb-2.5`}
        >
          Wedding Entourage
        </h2>
        ...
        {/* Sublabel */}
        <p
          className={`${cormorant.className} text-xs sm:text-sm md:text-base text-[#85441E] mb-2 sm:mb-2.5 md:mb-3 italic`}
        >
      ...
      >
        {/* Card with new theme */}
        <div className="relative bg-[#FFF7F6] backdrop-blur-lg rounded-xl sm:rounded-2xl overflow-hidden border-4 border-[#85441E]/30 shadow-[0_18px_40px_rgba(133,68,30,0.15)] hover:border-[#85441E]/50 transition-all duration-500 group">
          {/* Card content */}
            ...
            {isLoading ? (
              <div className="flex items-center justify-center py-24 sm:py-28 md:py-32">
                <div className="flex flex-col items-center gap-4">
                  <Loader2 className="h-10 w-10 sm:h-12 sm:w-12 animate-spin text-[#85441E]/70" />
                  <span className={`text-[#85441E]/80 ${cormorant.className} text-base sm:text-lg`}>Loading entourage...</span>
                </div>
              </div>
            ) : error ? (
              <div className="flex items-center justify-center py-24 sm:py-28 md:py-32">
                <div className="text-center">
                  <p className={`text-[#85441E] ${cormorant.className} text-base sm:text-lg mb-3`}>{error}</p>
                  <button
                    onClick={fetchEntourage}
                    className={`text-[#85441E]/90 hover:text-[#85441E] ${cormorant.className} underline transition-colors duration-200`}
                  >
                    Try again
                  </button>
                </div>
              ...
              <div className="text-center py-24 sm:py-28 md:py-32">
                <Users className="h-14 w-14 sm:h-16 sm:w-16 text-[#85441E]/30 mx-auto mb-4" />
                <p className={`text-[#85441E]/60 ${cormorant.className} text-base sm:text-lg`}>No entourage members yet</p>
              </div>
            ) : (
            <>
                    ...
                    <div key={category}>
                      {categoryIndex > 0 && (
                        <div className="flex justify-center py-2 sm:py-2.5 md:py-3 mb-2 sm:mb-2.5 md:mb-3">
                          <div className="w-full max-w-md h-px bg-gradient-to-r from-transparent via-[#85441E]/30 to-transparent"></div>
                        </div>
                      )}
                  ...
                  if (category === "Best Man") {
                    return (
                      <div key="HonorAttendants">
                        ...
                        <TwoColumnLayout leftTitle="Best Man" rightTitle="Maid of Honorr">
                          {(() => {
