...
const galleryItems = [
  ...
  { image: "/gallery/couple (2).webp", text: "" },
  { image: "/gallery/couple (3).webp", text: "" },
...
export function Gallery() {
  ...
  return (
    <Section
      id="gallery"
      className="relative py-10 sm:py-12 md:py-16 lg:py-20 overflow-hidden bg-gradient-to-b from-[#EFBE94]/95 via-[#F7E4CF] to-[#EFBE94]/95"
    >
      {/* Corner accents - glam barn */}
      ...
      <div className="absolute left-0 bottom-0 z-0 pointer-events-none opacity-80">
        <div
          className="w-[100px] h-[100px] sm:w-[140px] sm:h-[140px] md:w-[180px] md:h-[180px] bg-[#935F3B]/40"
          style={{
      ...
      <div className="absolute right-0 bottom-0 z-0 pointer-events-none opacity-80">
        <div
          className="w-[100px] h-[100px] sm:w-[140px] sm:h-[140px] md:w-[180px] md:h-[180px] bg-[#935F3B]/40"
          style={{
            maskImage: 'url("/decoration/cornerbottom.png")',
      ...
      <div className="relative z-10 text-center mb-8 sm:mb-10 md:mb-12 px-4">
        <div className="space-y-2 sm:space-y-3">
          ...
          >
            <span className="block">Cherished Moments</span>
            <span className="block">with {coupleDisplayName}</span>
          </p>
          <h2
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          ...
          <motion.div
            className="w-1.5 h-1.5 rounded-full bg-[#85441E]/80"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.7, 1, 0.7],
            }}
      ...
      {selectedImage && (
        ...
        >
            ...
            <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between p-2 sm:p-3 md:p-4 lg:p-6">
              <div className="bg-[#935F3B]/95 backdrop-blur-md rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 border border-[#85441E]/60">
              ...
              <button
                ...
                className="bg-[#935F3B]/95 hover:bg-[#85441E] active:bg-[#85441E]/95 backdrop-blur-md rounded-full p-1.5 sm:p-2 md:p-2.5 lg:p-3 transition-all duration-200 border border-[#85441E]/60 hover:border-[#85441E] touch-manipulation"
            ...
            {galleryItems.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-1 sm:left-2 md:left-4 top-1/2 -translate-y-1/2 z-20 bg-[#935F3B]/95 hover:bg-[#85441E] active:bg-[#85441E]/95 backdrop-blur-md rounded-full p-2 sm:p-2.5 md:p-3 lg:p-4 transition-all duration-200 border border-[#85441E]/60 hover:border-[#85441E] touch-manipulation"
                ...
                <button
                  ...
                  className="absolute right-1 sm:right-2 md:right-4 top-1/2 -translate-y-1/2 z-20 bg-[#935F3B]/95 hover:bg-[#85441E] active:bg-[#85441E]/95 backdrop-blur-md rounded-full p-2 sm:p-2.5 md:p-3 lg:p-4 transition-all duration-200 border border-[#85441E]/60 hover:border-[#85441E] touch-manipulation"
              ...
              >
                ...
                {zoomScale > 1 && (
                  <button
                    ...
                    className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 bg-[#935F3B]/95 hover:bg-[#85441E] backdrop-blur-md text-white rounded-full px-2 py-1 sm:px-3 sm:py-1.5 text-[10px] sm:text-xs font-medium border border-[#85441E]/60 transition-all duration-200 touch-manipulation z-20"
                  >
                    Reset zoom
                  </button>
                )}
            ...
            {galleryItems.length > 1 && (
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 sm:hidden z-20">
                <p className="text-[10px] text-white/80 bg-[#935F3B]/90 backdrop-blur-sm rounded-full px-2 py-1 border border-[#85441E]/50">
                  Swipe to navigate
                </p>
              </div>
            )}
      ...
      <div className="relative z-10 mt-8 sm:mt-10 md:mt-12 flex justify-center px-4">
        <motion.a
          href="/gallery"
          className="group inline-flex items-center gap-2 px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-3.5 md:py-4 rounded-lg sm:rounded-xl font-semibold sm:font-bold transition-all duration-300 uppercase tracking-wider text-xs sm:text-sm md:text-base whitespace-nowrap relative overflow-hidden border-2 backdrop-blur-sm text-[#EFBE94]"
          style={{
            backgroundColor: "#85441E",
            borderColor: "#85441E",
            color: "#EFBE94",
            boxShadow: "0 6px 26px rgba(133,68,30,0.45), 0 2px 10px rgba(133,68,30,0.6)",
          }}
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.borderColor = "#6d361b";
            e.currentTarget.style.boxShadow = "0 10px 34px rgba(133,68,30,0.55), 0 4px 14px rgba(133,68,30,0.8)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = "#85441E";
            e.currentTarget.style.borderColor = "#85441E";
            e.currentTarget.style.boxShadow = "0 6px 26px rgba(133,68,30,0.45), 0 2px 10px rgba(133,68,30,0.6)";
          }}
        >
          ...
          <div 
            className="absolute inset-0 bg-gradient-to-r from-transparent via-[#EFBE94]/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 transform -skew-x-12 -translate-x-full group-hover:translate-x-full"
          />
          {/* Pulsing glow effect */}
          <motion.div 
            className="absolute inset-0 bg-[#85441E]/25 rounded-lg sm:rounded-xl blur-xl -z-10"
            animate={{
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.1, 1],
            }}
