...
const COUNTDOWN_BOXES = [
  { src: '/gallery/couple (1).webp' },
  { src: '/gallery/couple (2).webp' },
  { src: '/gallery/couple (3).webp' },
];
...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({ onComplete }) => {
  ...
  const countdown = useMemo(() => {
    const wedding = new Date('2026-06-27T14:00:00');
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col flex-1 min-h-0">
        {/* Top: Wedding label + hashtag + countdown - refined styling, centered on mobile */}
        ...
        <div className="flex flex-col items-center justify-center w-full py-6 sm:py-8 px-4 flex-shrink-0">
          ...
          <p
            className="text-xs sm:text-sm tracking-widest mt-6 mb-3 font-sans uppercase text-white"
          >
            Preparing your invitation
          </p>
          <div className="w-full max-w-xs mx-auto">
            <div
              className="h-1 rounded-full overflow-hidden bg-white/30"
            >
              <div
