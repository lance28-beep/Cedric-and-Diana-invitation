    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(239,190,148,0.35), rgba(239,190,148,0.7))",
          }}
        />
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse at center, transparent 0%, rgba(239,190,148,0.35) 100%)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-6 w-full max-w-md mx-auto h-full">
        ...
        <div className="flex flex-col items-center justify-end w-full gap-5 sm:gap-6 pb-14 sm:pb-16 md:pb-20">
          ...
          <h1
            className={`text-5xl md:text-7xl font-bold tracking-wider uppercase transition-all duration-1000 ease-out delay-300 text-white ${
              contentVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
            style={{
          ...
          <button
            type="button"
            onClick={onOpen}
            className={`px-10 py-4 text-sm font-[family-name:var(--font-crimson)] tracking-[0.2em] uppercase rounded-sm border border-[#85441E] bg-[#85441E] text-zinc-100 transition-all duration-500 delay-500 hover:bg-[#6B3618] hover:border-[#6B3618] active:scale-[0.98] ${
              contentVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            Open Invitation
