...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL ?? "https://cedric-and-diana.weddinginvitationrsvp.com/"
...
const granika = localFont({
  src: "../granika-font/Granika-MAm6r.otf",
  variable: "--font-granika",
})
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className={`${inter.variable} ${greatVibes.variable} ${imperialScript.variable} ${cinzel.variable} ${granika.variable} font-inter antialiased text-foreground`}
      >
        {children}
        <Analytics />
      </body>
