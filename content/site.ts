export const siteConfig = {
  couple: {
    bride: "Diana Valenzuela",
    brideNickname: "Diana",
    groom: "Cedric Müller",
    groomNickname: "Cedric",
  },
  wedding: {
    date: "JUNE 27, 2026",
    time: "2:00 PM",
    venue: "St. Jost Kapelle",
  ...
  ceremony: {
    location: "St. Jost Kapelle, 6373 Ennetbürgen",
    venue: "St. Jost Kapelle",
    date: "June 27 2026",
    day: "Saturday",
    time: "2:00 PM",
...
Now, as they prepare to say yes before God and the people they love most, Catherine is grateful for the patience, humor, and hope Mark brings to every day. She knows this next chapter is just the start of the love story they get to write together.`,
  ...
  snapShare: {
    ...
    hashtag: "#CedricAndDiana",
    instructions: "Please scan this QR Code, create a folder with your name and upload the photos and videos you have taken during our wedding reception. We are delighted to see your snaps too!",
    productionCredit: "", // e.g. "@MJPPRODUCTIONS"
  },
}
